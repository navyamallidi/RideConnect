    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        RegisterCustomerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(customerlogin.this, "Please write your Email...", Toast.LENGTH_SHORT).show();
                }

                if(TextUtils.isEmpty(password))
                {
                    Toast.makeText(customerlogin.this, "Please write your Password...", Toast.LENGTH_SHORT).show();
                }
                ...
                else
                {
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task)
                        {
                            ...
                            {
                                Toast.makeText(customerlogin.this, "Please Try Again. Error Occurred, while registering... ", Toast.LENGTH_SHORT).show();
                ...
                else
                {
                    ...
                    mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task)
                        {
                            ...
                            {
                                Toast.makeText(customerlogin.this, "Error Occurred, while Signing In... ", Toast.LENGTH_SHORT).show();
